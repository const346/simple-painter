...
**
** Created: Wed 11. Dec 20:22:08 2013
...
static const char qt_meta_stringdata_LineTool[] = {
    "LineTool\0\0i\0sizeChanged(int)\0"
};

const QMetaObject LineTool::staticMetaObject = {
    { &AbstractTool::staticMetaObject, qt_meta_stringdata_LineTool,
      qt_meta_data_LineTool, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LineTool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LineTool))
        return static_cast<void*>(const_cast< LineTool*>(this));
